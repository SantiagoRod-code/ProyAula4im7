 ...
 * @author PC
 */
public class Tema1CalDif extends javax.swing.JFrame {

    /**
     * Creates new form Tema1CalDif
     */
    public Tema1CalDif() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tema1CalDif.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tema1CalDif().setVisible(true);
            }
        });
    }
